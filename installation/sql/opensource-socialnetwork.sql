...
CREATE TABLE IF NOT EXISTS `ossn_components` (
  ...
  `active` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 AUTO_INCREMENT=62 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `ossn_group_admins`
--
ALTER TABLE `ossn_group_admins`
...
--
-- AUTO_INCREMENT for table `ossn_group_admins`
--
ALTER TABLE `ossn_group_admins`
  MODIFY `group_admin_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
COMMIT;
