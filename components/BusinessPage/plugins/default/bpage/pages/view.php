...
<div class="container business-page">
	<div class="row">
    	<div class="col-md-2">
				...
				?>
                <div class="controls">
	                <a href="<?php echo ossn_site_url("page/edit/{$params['page']->guid}");?>" class="btn btn-success"><?php echo ossn_print('bpage:edit');?></a>
    	            <a href="<?php echo ossn_site_url("action/bpage/delete?guid={$params['page']->guid}", true);?>" class="btn btn-danger ossn-make-sure"><?php echo ossn_print('bpage:delete');?></a>
                </div>    
                <?php } 
				}?>
