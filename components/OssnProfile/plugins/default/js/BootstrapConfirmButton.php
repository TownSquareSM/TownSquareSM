...
$(this).each(function(idx, btn) {
	...
	function resetBtn() {
		thisBtn$.html(oriHtml).addClass(optsEl.initialclass).removeClass(optsEl.classname).data('confirmed',false);
	}
	...
	thisBtn$.on('click.confirm', function(e) {
		...
		else
		{
			...
			thisBtn$.html(optsEl.msg).removeClass(optsEl.initialclass).addClass(optsEl.classname).bind('mouseout.confirm', function() {
