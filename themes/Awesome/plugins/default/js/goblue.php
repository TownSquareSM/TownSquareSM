...
$(document).ready(function() {
	...
	$('#ossn-home-signup').find('input[type="text"]').addClass('form-control');
	$('#ossn-home-signup').find('input[type="passsword"]').addClass('form-control');
	$('#ossn-home-signup').find('select').addClass('form-control');
	...
	$(".label-danger").addClass("badge-danger");
	$(".label-primary").addClass("badge-primary");
});
$(document).ready(function() {
