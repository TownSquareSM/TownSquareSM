 <fieldset class="titleform">
 	...
 	<div>	
  	...
  	<div>	
    	<label><?php echo ossn_print('theme:goblue:background');?> (1500 - 763 KB JPG)</label>
        <input type="file" name="background" />
        <div class="logo-container-goblue">
            			<?php if(ossn_site_settings('cache') == true){?>
            			<img src="<?php echo ossn_theme_url(); ?>images/background.jpg"/>
                        <?php } else { ?>
            			<img src="<?php echo ossn_theme_url(); ?>images/background.jpg?ver=<?php echo time();?>"/>                        
                        <?php } ?> 
        </div>
    </div>       
