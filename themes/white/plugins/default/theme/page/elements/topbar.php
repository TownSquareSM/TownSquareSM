	...
	<div class="container-fluid">
    	<div class="row site-name-container">
            ...
            <div class="col-md-4 hidden-xs">
                    <a href="<?php echo ossn_site_url();?>login" class="btn btn-primary login-topbar">Login</a>
                    <a href="<?php echo ossn_site_url();?>login" class="btn btn-success register-topbar">Register</a>
            </div>
        </div>
    </div>
</div>
	...
	<div class="container-fluid">
    	<div class="row site-name-container">
        	<div class="col-md-12 site-name text-center">
                <span><img class="site-logo" src="<?php echo ossn_theme_url();?>images/logo.png" /></span>
            </div>
        </div>
...
<div class="topbar">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-2 col-lg-3 left-side left">
				<?php if(ossn_isLoggedin()){ ?>
			...
			<div class="hidden-xs hidden-sm col-md-7 col-lg-5 site-name text-center <?php echo $hide_loggedin;?>">
                <span><img class="site-logo-logged" src="<?php echo ossn_theme_url();?>images/logo.png" /></span>
			</div>
			<div class="col-md-3 col-lg-4 text-right right-side">
