...
.emojii-container .nav-tabs {
	border-bottom: 1px solid var(--main-border-color-bit);
}
.emojii-container .nav-tabs>li>a:hover {
...
.white-darkmode .emojii-list li:hover {
    background:var(--topbar-icons-hover);
}
...
.ossn-chat-base {
	font-family: 'Ubuntu' Verdana, Arial, "Bitstream Vera Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "NotoColorEmoji", "Segoe UI Symbol", "Android Emoji", "EmojiSymbols";
}

body {
	font-family: 'Ubuntu', sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "NotoColorEmoji", "Segoe UI Symbol", "Android Emoji", "EmojiSymbols";
}
